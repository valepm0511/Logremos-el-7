        ...
        <div class="col-12 col-md-8 col-sm-12 col-lg-5">
          <form class="form-inline">
            ...
            <div class="container">
              ...
              <div class="row mt-2">
                <div class="col-10 col-sm-6 col-md-7 col-lg-7 m-auto">
                  <button type="submit" class="btn btn-primary mb-2 col-12 btn-style_fb" onclick="window.data.loginFace()">
                    <i class="fab fa-facebook-square"></i>Facebook</button>
                </div>
              </div>
              <div class="row mt-2">
                <div class="col-10 col-sm-6 col-md-7 col-lg-7 m-auto">
                  <button type="submit" class="btn btn-primary mb-2 col-12 btn-style_g">
